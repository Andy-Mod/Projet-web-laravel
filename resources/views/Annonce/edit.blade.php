		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Modifier une annonce</h1>
				</header>
						...
						<div class="panel-body">
							...
							@csrf
								...
								<div class="top-margin">
									...
									<select id="inputState" name="tipe" class="form-control" value='{{$annonce->type}}' required>
								...
								<div class="top-margin">
									...
									<input type="text" name="prix" class="form-control" value='{{$annonce->prix}}' required>
								</div>

								<div class="top-margin">
									<label>Description</label>
									<input type="text" name="description" class="form-control" value='{{$annonce->description}}' required>
								</div>
								<div class="top-margin">
									<label>Contact</label>
									<input type="text" name="contact" class="form-control" value='{{$annonce->contact}}' required>
								</div>
								<br/>
