      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('showliste')}}">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <p class="text-white mt-0 mb-5">Ici, vous pouvez modifier votre profile</p>
      ...
      <div class="row">
        <div class="col-xl-4 order-xl-2">
          <div class="card card-profile">
            ...
            <div class="card-header text-center border-0 pt-18 pt-md-14 pb-10 pb-md-14">
              <div class="d-flex justify-content-between">
                <a href="#" class="btn btn-sm btn-info  mr-4 ">{{ Auth::user()->name }}</a>
                <a href="#" class="btn btn-sm btn-default float-right">{{ Auth::user()->email}}</a>
              </div>
            </div>
            <div class="card-body pt-0">
              ...
              <div class="text-center">
                <h1 class="h3">
                 Hello  <span class="font-weight-light"></span>
                </h1>
            </div>
          </div>
        </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" size="50" value='{{$name}}' disabled>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email address</label>
                        <input type="email" id="input-email" class="form-control" size="50" value='{{$email}}' disabled>
                      </div>
                      <div class="col-8">
                     <button>
