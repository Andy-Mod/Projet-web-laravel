...
<head>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">Bienvenue ! Ci après les annonces disponnibles</a>
                    <form class="d-flex">
                        ...
                        <div class="fs-5 mb-5">
                            ...
                            <div class="d-flex">
                                ...
                                <button class="btn btn-outline-dark flex-shrink-0" type="button">
                                    <i class="bi-cart-fill me-1"></i>
                                            Pour plus d'informations veillez contacter le : {{$j->contact}}
                                            
                                </button>
                                <br/>
                                <button class="btn btn-outline-dark flex-shrink-0" type="button">
                                    <i class="bi-cart-fill me-1"></i>
                                            Ou inscrivez vous pour un acces complet :
